...
""";
    ...
    switch(menuChoice) {
        case 1 -> {
          boolean phoneBookInterface = true;
          do {
...
""";
    ...
    System.out.println(options);
                ...
                switch(subOptions) {
                  ...
                  case 0 -> optionInterface = false;
                  default -> System.out.println("Invalid");
          }
      } while(optionInterface);
   }
      case 10 -> System.out.println("Speed dials: ");
      case 11 -> System.out.println("Voice tags: ");
      case 0 -> phoneBookInterface = false;
      default -> System.out.println("Invalid");       
          }
     } while(phoneBookInterface);
  }
     case 2 -> {
          boolean messageInterface = true;
          do {
...
""";
      ...
      case 7 -> {
                  boolean messageSettingsInterface = true;
                  do {
...
""";
        System.out.println(common);
                        ...
                        switch(subOption3) {
                            ...
                            case 0 -> messageSettingsInterface = false;
                            default -> System.out.println("Invalid");
                                }
                          } while(messageSettingsInterface);
                }
      case 8 -> System.out.println("Info service"); 
      case 9 -> System.out.println("Voice mailbox number");
      case 10 -> System.out.println("Service command editor");
      case 0 -> messageInterface = false;
      default -> System.out.println("Invalid");
              }
        } while(messageInterface);
      }
